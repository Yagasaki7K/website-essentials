define(["exports"], function (t) {
		...
		findMatchingRoute({ url: t, sameOrigin: e, request: s, event: n }) {
			...
			for (const i of r) {
				...
				if (a)
					return (
						(r = a),
						((Array.isArray(r) && 0 === r.length) || (a.constructor === Object && 0 === Object.keys(a).length) || "boolean" == typeof a) && (r = void 0),
						{ route: i, params: r }
					);
			}
			return {};
	...
	class m {
		constructor(t, e) {
			(this.h = {}), Object.assign(this, e), (this.event = e.event), (this.u = t), (this.l = new p()), (this.p = []), (this.g = [...t.plugins]), (this.m = new Map());
	...
	class R {
		constructor(t = {}) {
			(this.cacheName = w.getRuntimeName(t.cacheName)), (this.plugins = t.plugins || []), (this.fetchOptions = t.fetchOptions), (this.matchOptions = t.matchOptions);
		}
		handle(t) {
		...
		try {
			...
			const r = (function (t) {
				...
				a = (function (t, e, n) {
					...
					let i, a;
					return (
						void 0 !== e && void 0 !== n ? ((i = e), (a = n + 1)) : void 0 !== e && void 0 === n ? ((i = e), (a = r)) : void 0 !== n && void 0 === e && ((i = r - n), (a = r)),
						{ start: i, end: a }
					);
				})(i, r.start, r.end),
	...
	class Z extends R {
		constructor(t = {}) {
			(t.cacheName = w.getPrecacheName(t.cacheName)), super(t), (this.W = !1 !== t.fallbackToNetwork), this.plugins.push(Z.copyRedirectedCacheableResponsesPlugin);
		}
		async D(t, e) {
		...
		async S(t, e) {
				...
				});
			{
				const s = r.integrity,
					i = t.integrity,
					a = !i || i === s;
				(n = await e.fetch(new Request(t, { integrity: "no-cors" !== t.mode ? i || s : void 0 }))), s && a && "no-cors" !== t.mode && (this.K(), await e.cachePut(t, n.clone()));
			}
			return n;
		}
		async j(t, e) {
		...
		K() {
			let t = null,
				e = 0;
			for (const [s, n] of this.plugins.entries()) n !== Z.copyRedirectedCacheableResponsesPlugin && (n === Z.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++);
