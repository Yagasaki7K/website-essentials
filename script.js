...
function ptbr() {
    ...
    document.getElementById('head2').innerHTML = 'Softwares para um bom funcionamento e úteis para seu computador | <i>Build 1.6.9</i> de 25 de Maio —';
...
function enusa() {
    ...
    document.getElementById('head2').innerHTML = 'Softwares for a good functioning and useful for your computer | <i> Build 1.6.9 </i> of May 25th -';
