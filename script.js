...
function ptbr() {
    ...
    document.getElementById('copyright2').innerHTML = '© Copyright 2017-2019 | Esse site é desenvolvido por <a href="https://www.facebook.com/AndersonMarlonDesign/" target="_blank">Anderson Marlon</a> e hospedado em <a href="https://www.netlify.com/" target="_blank">Netflify</a>. O código do site está hospedado no <a href="http://www.github.com/" target="_blank">GitHub</a>';
}
...
function enusa() {
    ...
    document.getElementById('copyright2').innerHTML = '© Copyright 2017-2019 | Thie site is build for <a href="https://www.facebook.com/AndersonMarlonDesign/" target="_blank">Anderson Marlon</a> and hosted on <a href="https://www.netlify.com/" target="_blank">Netflify</a>. The source code is hosted on <a href="http://www.github.com/" target="_blank">GitHub</a>.';
}
